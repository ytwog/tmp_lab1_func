        ...
        for(text* i = c.start; i != c.end; i = i->next) {
            for(text* j = i->next; j != c.start; j = j->next) {
                ...
                switch(i->type) {
                    ...
                    case REPLACEMENT:
                        switch(j->type) {
                            ...
                            case CYCLE:
                                ...
                                break;
                            case DIGIT_REPL:
                                ofstr << "Replacement and digit_replacement";
                                str2 = info_string((txt_digit_repl*)j);
                                break;
                        }
                        break;
                    // CYCLE
                    case CYCLE:
                        ...
                        switch(j->type) {
                            ...
                            case CYCLE:
                                ...
                                break;
                            case DIGIT_REPL:
                                ofstr << "Cycle and digit_replacement";
                                str2 = info_string((txt_digit_repl*)j);
                                break;
                        }
                        break;
                    // DIGIT REPLACEMENT
                    case DIGIT_REPL:
                        str1 = info_string((txt_digit_repl*)i);
                        switch(j->type) {
                            case REPLACEMENT:
                                ofstr << "Digit_replacement and replacement";
                                str2 = info_string((txt_replacement*)j);
                                break;
                            case CYCLE:
                                ofstr << "Digit_replacement and cycle";
                                str2 = info_string((txt_cycle*)j);
                                break;
                            case DIGIT_REPL:
                                ofstr << "Digit_replacement and digit_replacement";
                                str2 = info_string((txt_digit_repl*)j);
                                break;
                        }
                        break;
